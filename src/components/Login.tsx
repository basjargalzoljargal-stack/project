...
export default function Login({ onLogin, onRegisterClick, onForgotPasswordClick }: LoginProps) {
      ...
      <div className="w-full max-w-md">
        <Card shadow="xl" padding="lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {!isRegistering && onForgotPasswordClick && (
            ...
            <div className="text-center pt-4 border-t border-slate-200">
              <button
                type="button"
                onClick={() => {
                  if (onRegisterClick && !isRegistering) {
                    onRegisterClick();
                  } else {
