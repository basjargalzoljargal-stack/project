...
export default function Dashboard({ onLogout, onDepartmentsClick, onNewProposalClick, onMyProposalsClick, onProposalReviewClick, onAssignmentsClick, onCompletionsReviewClick, onCompletionsClick, onReportsClick, onChatClick, onAdvancedCalendarClick, onAdminDashboardClick, onUserManagementClick, onDepartmentManagementClick }: DashboardProps) {
 ...
 const loadTasks = () => {
  ...
  return (
    <>
      {showAdmin ? (
        <AdminPage onBack={() => setShowAdmin(false)} onDepartmentsClick={onDepartmentsClick} />
      ) : (
        <div className="min-h-screen bg-slate-50 flex">
          <Sidebar
            ...
            onMyProposalsClick={onMyProposalsClick}
            onProposalReviewClick={onProposalReviewClick}
            onAssignmentsClick={onAssignmentsClick}
            onCompletionsReviewClick={onCompletionsReviewClick}
            onCompletionsClick={onCompletionsClick}
            onReportsClick={onReportsClick}
            onChatClick={onChatClick}
            onAdvancedCalendarClick={onAdvancedCalendarClick}
            onAdminDashboardClick={onAdminDashboardClick}
            onUserManagementClick={onUserManagementClick}
            onDepartmentManagementClick={onDepartmentManagementClick}
          />
